...
error FundMe__NotOwner(); //name errors by contract name so that you can easily figure out from which contract the error is.

contract FundMe {
    using PriceConverter for uint256;
    AggregatorV3Interface a_pricefeed;
    ...
    function fund() public payable {
        require(msg.value.getConversionRate(a_pricefeed) >= MINIMUM_USD, "You need to spend more ETH!");
